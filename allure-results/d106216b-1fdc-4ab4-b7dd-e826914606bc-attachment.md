...
- heading "David Sam" [level=3]
- button " Upload Image"
- button "Choose File"
- text: File types allowed - .jpeg / .jpg / .png / .gif (Max file size - 1 MB) DJ1101027
...
- combobox "Select Salutation Mr. Ms. Mrs. Dr. Prof. Mx.":
  ...
  - option "Mx."
- text: Salutation 
- textbox "First Name *": David
- text: First Name * 
- textbox "Middle Name": Joe
- text: Middle Name 
- textbox "Last Name *": Sam
- text: Last Name * 
- textbox "Date of Birth *": 11/29/1990
- text: Date of Birth * 
- textbox "Social Security Number (SSN) *": 343-78-9945
- text:  Social Security Number (SSN) *  (+1)
- textbox "Mobile Number *": 237-653-4567
- text: Mobile Number * 
- textbox "Home Phone": "6325296542"
- text: Home Phone 
...
- combobox:
  - list:
    ...
    - listitem "ABS":
      - button "Remove item"
      - text: ABS 
    - listitem "Accenture FOUNDATION":
      - button "Remove item"
      - text: Accenture FOUNDATION 
    - listitem "ACLS":
      - button "Remove item"
      - text: ACLS 
    - listitem "Acquisitions":
      - button "Remove item"
      - text: Acquisitions 
  - searchbox
