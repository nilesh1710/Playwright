...
- heading "Mac Smith" [level=3]
- button " Upload Image"
- button "Choose File"
- text: File types allowed - .jpeg / .jpg / .png / .gif (Max file size - 1 MB) FG1101721
...
- combobox "Select Salutation Mr. Ms. Mrs. Dr. Prof. Mx.":
  ...
  - option "Mx."
- text: Salutation 
- textbox "First Name *": Mac
- text: First Name * 
- textbox "Middle Name"
- text: Middle Name 
- textbox "Last Name *": Smith
- text: Last Name * 
- textbox "Date of Birth *": 08/26/2025
- text: Age should be greater than 18 years. Date of Birth * 
- textbox "Social Security Number (SSN) *": 128-00-6739
- text:  Social Security Number (SSN) *  (+1)
- textbox "Mobile Number *": 234-769-8765
- text: Mobile Number * 
- textbox "Home Phone"
- text: Home Phone 
- textbox "E-mail Address *": hrd29@mailinator.com
- text: E-mail Address *
