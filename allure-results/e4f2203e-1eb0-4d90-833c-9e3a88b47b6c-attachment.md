...
- paragraph
- link "You have 4 step(s) to complete":
  - /url: https://dev.kredsafe.net/user/residencies
  - heading "You have 4 step(s) to complete" [level=3]
- paragraph
- progressbar: 56%
- heading "Residency" [level=1]
- list:
  - listitem:
    - link "Dashboard":
      - /url: "https://dev.kredsafe.net/admin/home "
  - listitem: "> Residency"
- button "View Archive of Residencies"
- text: Residency
- img:
  - img
- text: 
...
- alert:
  - text: Success !
  - button "Close"
  - paragraph: Internship information has been updated successfully.
```