...
- heading "Niraj User" [level=3]
- button " Upload Image"
- button "Choose File"
- text: File types allowed - .jpeg / .jpg / .png / .gif (Max file size - 1 MB) FH2001738
...
- textbox "Mobile Number *": 240-039-9345
- text: Mobile Number * 
- textbox "Home Phone"
- text: Home Phone 
- textbox "E-mail Address *": ts097110@yopmail.com
- text: E-mail Address *
