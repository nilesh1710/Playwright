...
- navigation:
  - list:
    ...
    - listitem:
      - img "KredSafe"
  - list:
    - listitem: "Previous Login: 31 seconds ago"
    - listitem:
      - link " .":
        - /url: "#"
    - listitem:
...
- 'heading "Standard Plan - Tenure: " [level=2]':
  ...
  - link "":
    - /url: https://dev.kredsafe.net/user/subscription/cart/955/remove
...
- link " Edit Subscription":
  - /url: https://dev.kredsafe.net/user/subscription/cart/955/edit
- button "Confirm & Pay"
