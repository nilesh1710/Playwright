...
- navigation:
  - list:
    ...
    - listitem:
      - img "KredSafe"
  - list:
    - listitem: "Previous Login: 46 seconds ago"
    - listitem:
      - link " .":
        - /url: "#"
    - listitem:
...
- link "You have 6 step(s) to complete":
  ...
  - heading "You have 6 step(s) to complete" [level=3]
- paragraph
- progressbar: 33%
- heading "Professional Education" [level=1]
- list:
  - listitem:
    - link "Dashboard":
      - /url: "https://dev.kredsafe.net/admin/home "
  - listitem: "> Professional Education"
- button "View Archive Professional Educations"
- text: Professional Education
- img:
  - img
- text: 
- textbox "Institution Name *": TIU
- text: Institution Name * 
- textbox "Subject of Study *": sos
