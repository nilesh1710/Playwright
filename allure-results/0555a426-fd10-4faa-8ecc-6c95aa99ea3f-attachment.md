...
- heading "Sam Smith" [level=3]
- button " Upload Image"
- button "Choose File"
- text: File types allowed - .jpeg / .jpg / .png / .gif (Max file size - 1 MB) FG2401722
...
- textbox "Social Security Number (SSN) *": 127-00-6739
- text:  Social Security Number (SSN) *  (+1)
- textbox "Mobile Number *": 232-347-6987
- text: Mobile Number * 
- textbox "Home Phone"
- text: Home Phone 
- textbox "E-mail Address *": hrd1@yopmail.com
- text: E-mail Address *
